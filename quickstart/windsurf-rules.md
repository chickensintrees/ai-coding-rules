...
Before creating a new file, function, or component, search the codebase for existing implementations. If something similar exists, extend or modify it. If a new implementation is genuinely needed, explain why the existing one doesn't work.
